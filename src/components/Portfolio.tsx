...
import { ChevronLeft, ChevronRight, Grid, Sliders as Slideshow } from 'lucide-react';
...
const Portfolio: React.FC<PortfolioProps> = ({ config }) => {
  ...
  const [isGridView, setIsGridView] = useState(config.isGrid);
    ...
    >
      ...
      >
        ...
        >
          ...
          <div 
            className="w-24 h-1 bg-primary dark:bg-primary-light mx-auto mb-8"
            aria-hidden="true"
          />
          ...
          >
            <motion.button
              ...
              className={`flex items-center space-x-2 px-4 py-2 rounded-md transition-colors ${
                !isGridView 
                  ? 'bg-primary dark:bg-primary-light text-white dark:text-dark-surface' 
        ...
        <div className="max-w-6xl mx-auto">
          {isGridView ? (
            ...
            >
              {config.items.map((item, index) => (
                ...
                >
                  ...
                  />
                  <div 
                    className="absolute inset-0 bg-gradient-to-t from-dark-bg/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    aria-hidden="true"
                  >
            ...
            <div 
              ref={slideRef}
              className="relative aspect-[16/9] overflow-hidden rounded-3xl shadow-2xl bg-dark-bg"
              role="region"
            ...
            >
              ...
              <AnimatePresence initial={false} custom={currentSlide}>
                ...
                >
                  <div className="relative h-full">
                    <img
                      src={config.items[currentSlide].url}
                      alt={config.items[currentSlide].title}
                      className="w-full h-full object-cover"
                      draggable="false"
                    />
                    <div 
                      className="absolute inset-0 bg-gradient-to-t from-dark-bg/80 to-transparent"
                      aria-hidden="true"
                    >
              ...
              <div className="absolute inset-0 flex items-center justify-between px-4 pointer-events-none">
                <motion.button
                  onClick={prevSlide}
                  className="z-10 pointer-events-auto p-3 bg-light-surface/90 dark:bg-dark-surface/90 rounded-full shadow-lg hover:bg-light-surface dark:hover:bg-dark-surface transition-colors backdrop-blur-sm"
